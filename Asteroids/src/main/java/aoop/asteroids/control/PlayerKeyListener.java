...
public class PlayerKeyListener implements KeyListener {
	 ...
	 *
	 * @param game The game, which has the ship that this key listener will control.
	 */
	public PlayerKeyListener(Game game) {
		this.game = game;
	}
	...
	public void keyPressed(KeyEvent event) {
		switch (event.getKeyCode()) {
			case ACCELERATION_KEY:
				this.game.getSpaceship().setAccelerateKeyPressed(true);
				break;
			case LEFT_KEY:
				this.game.getSpaceship().setTurnLeftKeyPressed(true);
				break;
			case RIGHT_KEY:
				this.game.getSpaceship().setTurnRightKeyPressed(true);
				break;
			case FIRE_WEAPON_KEY:
				this.game.getSpaceship().setIsFiring(true);
		}
	}
	...
	public void keyReleased(KeyEvent event) {
		switch (event.getKeyCode()) {
			case ACCELERATION_KEY:
				this.game.getSpaceship().setAccelerateKeyPressed(false);
				break;
			case LEFT_KEY:
				this.game.getSpaceship().setTurnLeftKeyPressed(false);
				break;
			case RIGHT_KEY:
				this.game.getSpaceship().setTurnRightKeyPressed(false);
				break;
			case FIRE_WEAPON_KEY:
				this.game.getSpaceship().setIsFiring(false);
		}
	}
