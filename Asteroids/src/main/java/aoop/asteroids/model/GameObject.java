...
public abstract class GameObject {
	...
	/**
	 * Correct drawing of object.
	 */
	public void spectateImplementation(double velX, double velY, double locX, double locY) {
		getLocation().y = (AsteroidsFrame.WINDOW_SIZE.height + locY + velY) % AsteroidsFrame.WINDOW_SIZE.height;
		getLocation().x = (AsteroidsFrame.WINDOW_SIZE.width + locX + velX) % AsteroidsFrame.WINDOW_SIZE.width;
	}
}
