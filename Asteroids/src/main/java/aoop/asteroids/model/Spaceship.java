...
public class Spaceship extends GameObject {
	...
	/**
	 * Nickname of the player and the color of the ship
	 */
	...
	/**
	 * Setter to set the : nickname of the player
	 */
	...
	/**
	 * Setter to set the : color of the ship
	 */
	...
	/**
	 * Setter to set the new direction
	 */
